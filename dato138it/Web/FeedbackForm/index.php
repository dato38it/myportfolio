        ...
        <div class="container">
            <div class="header__inner">
                ...
                <nav class="nav--colorWeb" id="nav--colorWeb">
                    <a class="nav__link--colorWeb" href="#" data-scroll="#contact">Feedback</a>
        ...
        <div class="intro--imgWeb" id="intro">
            <div class="container">
                <div class="intro__inner">
                    ...
                    <a class="btn" href="#" data-scroll="#contact">Feedback</a>
                </div>
            </div>
        </div><!-- /.intro -->
        <!--Footer-->
        <footer class="section--colorWeb" id="contact">
            <div class="container">
                <div class="section__header">
                     <h2 class="section__title--color">Feedback</h2>
                </div>
                <div class="footer__inner">
                    <div class="footer__col  footer__col--first">
                        ...
                        <form action="http://dato138it.ru/Web/FeedbackForm/index.php#form__anchor" method="post" name="f1"> 
