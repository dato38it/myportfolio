...
ClickTaleGlobal.scripts.versions = {"wr": "bridge-WR110.js", "pcc": "40df33f9-bf69-40d4-a4af-de312cf05b39.js?DeploymentConfigName=Release_20220822&Version=1"};
(function (d) {
	var dom="h",
	...
	ClickTaleGlobal.init.isAllowed = (function() {
						var doms = ["LHaVuhJVT","LHaVuhPu","BwZZJhJu"];
...
;
(function () {
    var selectorForBoth = 'button#dropdownMenuButton.header-utility-nav__signin';
...
if(!ClickTaleGlobal.init.pccRequested) {
	    ...
	    pccSrc += '40df33f9-bf69-40d4-a4af-de312cf05b39.js?DeploymentConfigName=Release_20220822&Version=1';
...
function sendCVar() {
	...
	if (!!data && !data.length) {
		...
		!!data && !!data[0] && !!data[0]["businessGroup"] && window._uxa.push(['setCustomVariable', 4, 'Business Group', data[0]["businessGroup"]]);
	}
}
...
//Signature:GSWpw98DkWP8PqE8UJVUwsW8nxc25mRoNDXObO91ep/mDgZACZF5qHQFG/Y7EGbSWZm9ifkuKFUBrZaQJ1eT+JDdTFrlreBNiYOf6sLNMJoElT5Sr/4qqkbx8mVdkYPA55StYElGYWbJUdqV5FqHLqHBJUYHzuc81oa/MdZVeSA=